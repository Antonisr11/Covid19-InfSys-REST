...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-2 d-flex align-items-center justify-content-center">
            <button type="button" class="btn-lg upper-button" onclick='window.location.href = "http://localhost:8080/Project_war_exploded/simple/bookAppointment.jsp"' style="background-color:#6E8898; color: #D9B48F;">Κράτηση Ραντεβού</button>
        </div>
    </div>
    <br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <h2>Είναι διαθέσιμα τα εξής ραντεβού:</h2>
        </div>
    </div>
    <br>
    <div class="row">
       ...
       <div class="col-md-6">
           <table class="table table-bordered" style='font-size:25px; text-align: center;'>
               ...
               <tr>
                   ...
                   <td><button type="button" class="btn btn-primary" onclick="window.location = 'http://localhost:8080/Project_war_exploded/simple/bookAppointment.jsp?appointmentDate=<%=appointment.substring(0, 10)%>';">Κράτηση</button></td>
               </tr>
               <%
                   }
               %>
...
<footer class="footer">
    <input type="submit" name="button" class="button big-button" onClick="window.location.reload();" value="Ανανεωση σελιδας">
    <h3>Antonisr11</h3>
</footer>
