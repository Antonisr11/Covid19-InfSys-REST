...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-1 d-flex align-items-center justify-content-center">
            <button type="button" class="btn-lg upper-button" style="background-color:#6E8898; color: #D9B48F;" onclick='window.location.href = "http://localhost:8080/Project_war_exploded/admin/showUsers.jsp"'>Προβολή μελών</button>
        </div>
        <div class="col-md-1 d-flex align-items-center justify-content-center">
               ...
               <tr>
                ...
                %>
                  <tr>
                    ...
                    <td><%=user_details.get(3).equals("0")?"Απλός Χρήστης":"Διαχειριστής"%></td>
                  </tr>
                <%
                    }
                %>
