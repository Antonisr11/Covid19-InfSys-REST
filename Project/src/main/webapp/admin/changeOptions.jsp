...
<div class="row">
    ...
    <div class="col-md-4 d-flex align-items-center justify-content-center">
        <form method="post">
            ...
            <div>
                <input type="submit" name="button" class="button big-button" value="Ορισμος Επιλογων">
            </div>
        </form>
    </div>
</div>
