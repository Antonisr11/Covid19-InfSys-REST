...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-2 d-flex align-items-center justify-content-center">
            <button type="button" class="btn-lg upper-button" onclick='window.location.href = "http://localhost:8080/Project_war_exploded/simple/showAppointments.jsp"' style="background-color:#6E8898; color: #D9B48F;">Προβολή Ραντεβού</button>
        </div>
        <div class="col-md-2 d-flex align-items-center justify-content-center">
               ...
               <tr>
                ...
                <%
                    for (int i = 0; i< appointments.size(); i++){
                        if (appointments.get(i).length()==0){
                            continue;
                        }
                %>
                  <tr>
